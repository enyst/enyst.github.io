...
- [Transpile maintenance](arch/openhands-transpile-maintenance.html): bounded review, DELEGATED server units,
  re-vendoring and TypeScript-owned provider compatibility previously supplied by LiteLLM.
...
- SDK: `smolpaws/openhands-agent`, `docs/TRANSPILE_CONTRACT.md`, `docs/LLM_PROVIDERS.md`,
  `docs/DRIFT_TOOLING.md`, `docs/DRIFT_AUTOMATION.md`, `transpile/upstream.json`.
...
- Work: Beads `smolpaws-zlo`, `smolpaws-kxa`, `kxa.2`, `kxa.4`–`kxa.9`, `39y`, `b1r.24`.
